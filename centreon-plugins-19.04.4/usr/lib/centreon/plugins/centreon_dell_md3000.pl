...
$fatpacked{"centreon/common/smcli/custom/custom.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_SMCLI_CUSTOM_CUSTOM';
  #
...
$fatpacked{"centreon/common/smcli/mode/healthstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_SMCLI_MODE_HEALTHSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/dell/MD3000/cli/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_DELL_MD3000_CLI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
