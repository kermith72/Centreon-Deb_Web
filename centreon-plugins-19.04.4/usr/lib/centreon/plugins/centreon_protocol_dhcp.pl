...
$fatpacked{"apps/protocols/dhcp/mode/connection.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_DHCP_MODE_CONNECTION';
  #
...
$fatpacked{"apps/protocols/dhcp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_DHCP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::protocols::dhcp::plugin;
