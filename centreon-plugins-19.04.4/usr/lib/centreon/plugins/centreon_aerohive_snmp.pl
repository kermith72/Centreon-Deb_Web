...
$fatpacked{"network/aerohive/snmp/mode/connectedusers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_AEROHIVE_SNMP_MODE_CONNECTEDUSERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/aerohive/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_AEROHIVE_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::aerohive::snmp::plugin;
  ...
  Check aerohive equipment in SNMP
