...
$fatpacked{"apps/bluemind/mode/incoming.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BLUEMIND_MODE_INCOMING';
  #
...
$fatpacked{"apps/bluemind/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BLUEMIND_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
