...
$fatpacked{"storage/hp/eva/cli/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_CUSTOM_API';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/battery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_BATTERY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/disk.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_DISK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/diskgrp.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_DISKGRP';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/fan.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_FAN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/iomodule.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_IOMODULE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/psu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_PSU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/system.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_SYSTEM';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/components/temperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_COMPONENTS_TEMPERATURE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_HARDWARE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/hp/eva/cli/mode/storageusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_MODE_STORAGEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package storage::hp::eva::cli::mode::storageusage;
  ...
  sub custom_usage_output {
      ...
      my $msg = sprintf("Storage '%s' Total: %s Used: %s (%.2f%%) Free: %s (%.2f%%)",
  ...
  sub manage_selection {
      ...
      $self->{xml_result} = $options{custom}->ssu_execute(commands => { 'ls system full xml' => 1 });
      
      # <object>
      #    <objectname>XXXX</objectname>
      #    <totalstoragespace>30168.18</totalstoragespace>
      #    <usedstoragespace>27935.14</usedstoragespace>
  
      foreach (@{$self->{xml_result}->{object}}) {
          $self->{storage} = { display => $_->{objectname}, 
              used => $_->{usedstoragespace} * 1024 * 1024 * 1024, total => $_->{totalstoragespace} * 1024 * 1024 * 1024
          };
      }
  }
...
$fatpacked{"storage/hp/eva/cli/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_EVA_CLI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
