...
$fatpacked{"apps/video/openheadend/snmp/mode/nodeusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VIDEO_OPENHEADEND_SNMP_MODE_NODEUSAGE';
  #
...
$fatpacked{"apps/video/openheadend/snmp/mode/operationstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VIDEO_OPENHEADEND_SNMP_MODE_OPERATIONSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/video/openheadend/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VIDEO_OPENHEADEND_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
