...
$fatpacked{"cloud/nutanix/snmp/mode/clusterusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_CLUSTERUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/mode/containerusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_CONTAINERUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::nutanix::snmp::mode::containerusage;
  ...
  sub custom_usage_calc {
      ...
      $self->{result_values}->{display} = $options{new_datas}->{$self->{instance} . '_display'};
      $self->{result_values}->{total} = $options{new_datas}->{$self->{instance} . '_citTotalCapacity'};
      $self->{result_values}->{used} = $options{new_datas}->{$self->{instance} . '_citUsedCapacity'};
      $self->{result_values}->{free} = $self->{result_values}->{total} - $self->{result_values}->{used};
      $self->{result_values}->{prct_used} = $self->{result_values}->{used} * 100 / $self->{result_values}->{total};
      $self->{result_values}->{prct_free} = 100 - $self->{result_values}->{prct_used};
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{container} = [
          ...
          { label => 'avg-latency', set => {
                  ...
                  output_template => 'Average Latency : %s µs',
                  perfdatas => [
                      { label => 'avg_latency', value => 'citAvgLatencyUsecs_absolute', template => '%s', unit => 'µs',
          ...
          { label => 'iops', set => {
                  ...
                  output_template => 'IOPs : %s',
                  perfdatas => [
                      { label => 'iops', value => 'citIOPerSecond_absolute', template => '%s', unit => 'iops',
                        min => 0, label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
  ...
  sub manage_selection {
      ...
      foreach my $oid (keys %{$snmp_result}) {
          ...
          $result->{citContainerName} = centreon::plugins::misc::trim($result->{citContainerName});
          if (defined($self->{option_results}->{filter_name}) && $self->{option_results}->{filter_name} ne '' &&
              $result->{citContainerName} !~ /$self->{option_results}->{filter_name}/) {
...
$fatpacked{"cloud/nutanix/snmp/mode/diskusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_DISKUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/mode/hypervisorusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_HYPERVISORUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/mode/listcontainers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_LISTCONTAINERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/mode/listdisks.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_LISTDISKS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::nutanix::snmp::mode::listdisks;
...
$fatpacked{"cloud/nutanix/snmp/mode/listhypervisors.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_LISTHYPERVISORS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::nutanix::snmp::mode::listhypervisors;
  ...
  my $oid_hypervisorName = '.1.3.6.1.4.1.41263.9.1.3';
  ...
  sub manage_selection {
      ...
      my $snmp_result = $self->{snmp}->get_table(oid => $oid_hypervisorName, nothing_quit => 1);
      $self->{hypervisor} = {};
      foreach my $oid (keys %{$snmp_result}) {        
          $snmp_result->{$oid} = centreon::plugins::misc::trim($snmp_result->{$oid});
          if (defined($self->{option_results}->{filter_name}) && $self->{option_results}->{filter_name} ne '' &&
  ...
  sub run {
      ...
      $self->manage_selection();
      foreach my $name (sort keys %{$self->{hypervisor}}) {
          $self->{output}->output_add(long_msg => "'" . $name . "'");
      }
...
$fatpacked{"cloud/nutanix/snmp/mode/liststoragepools.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_LISTSTORAGEPOOLS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::nutanix::snmp::mode::liststoragepools;
  ...
  my $oid_spitStoragePoolName = '.1.3.6.1.4.1.41263.7.1.3';
  ...
  sub manage_selection {
      ...
      my $snmp_result = $self->{snmp}->get_table(oid => $oid_spitStoragePoolName, nothing_quit => 1);
      $self->{sp} = {};
      foreach my $oid (keys %{$snmp_result}) {
          $snmp_result->{$oid} = centreon::plugins::misc::trim($snmp_result->{$oid});
          if (defined($self->{option_results}->{filter_name}) && $self->{option_results}->{filter_name} ne '' &&
              $snmp_result->{$oid} !~ /$self->{option_results}->{filter_name}/) {
              $self->{output}->output_add(long_msg => "skipping storage pool '" . $snmp_result->{$oid} . "'.", debug => 1);
              next;
          }
          
          $self->{sp}->{$snmp_result->{$oid}} = { name => $snmp_result->{$oid} };
      }
  }
  ...
  sub run {
      ...
      $self->manage_selection();
      foreach my $name (sort keys %{$self->{sp}}) {
          $self->{output}->output_add(long_msg => "'" . $name . "'");
      }
...
$fatpacked{"cloud/nutanix/snmp/mode/listvms.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_LISTVMS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/mode/storagepoolusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_STORAGEPOOLUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/mode/vmusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_MODE_VMUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/nutanix/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_NUTANIX_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
