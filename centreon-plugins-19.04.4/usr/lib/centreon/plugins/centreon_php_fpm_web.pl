...
$fatpacked{"apps/php/fpm/web/mode/usage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PHP_FPM_WEB_MODE_USAGE';
  #
...
$fatpacked{"apps/php/fpm/web/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PHP_FPM_WEB_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
