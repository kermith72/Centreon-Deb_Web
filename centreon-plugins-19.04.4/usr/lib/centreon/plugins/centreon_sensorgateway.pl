...
$fatpacked{"hardware/sensors/serverscheck/sensorgateway/snmp/mode/components/sensors.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SENSORS_SERVERSCHECK_SENSORGATEWAY_SNMP_MODE_COMPONENTS_SENSORS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/sensors/serverscheck/sensorgateway/snmp/mode/sensors.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SENSORS_SERVERSCHECK_SENSORGATEWAY_SNMP_MODE_SENSORS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/sensors/serverscheck/sensorgateway/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SENSORS_SERVERSCHECK_SENSORGATEWAY_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package hardware::sensors::serverscheck::sensorgateway::snmp::plugin;
  ...
  Check Sensorgateway sensors in SNMP.
