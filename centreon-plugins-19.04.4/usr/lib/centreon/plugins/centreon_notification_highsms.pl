...
$fatpacked{"notification/highsms/mode/alert.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NOTIFICATION_HIGHSMS_MODE_ALERT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"notification/highsms/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NOTIFICATION_HIGHSMS_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
