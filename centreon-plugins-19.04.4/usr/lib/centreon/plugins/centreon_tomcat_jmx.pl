...
$fatpacked{"apps/tomcat/jmx/mode/connectorusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TOMCAT_JMX_MODE_CONNECTORUSAGE';
  #
...
$fatpacked{"apps/tomcat/jmx/mode/datasourceusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TOMCAT_JMX_MODE_DATASOURCEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/tomcat/jmx/mode/listdatasources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TOMCAT_JMX_MODE_LISTDATASOURCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/tomcat/jmx/mode/listwebapps.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TOMCAT_JMX_MODE_LISTWEBAPPS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/tomcat/jmx/mode/webappssessions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TOMCAT_JMX_MODE_WEBAPPSSESSIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/tomcat/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TOMCAT_JMX_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/classcount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_CLASSCOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/cpuload.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_CPULOAD';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/fdusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_FDUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/gcusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_GCUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{gc} = [
          { label => 'time', set => {
                  ...
                  perfdatas => [
                      { label => 'time', value => 'time_absolute', template => '%s',
...
$fatpacked{"centreon/common/jvm/mode/loadaverage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_LOADAVERAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/memorydetailed.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_MEMORYDETAILED';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/jvm/mode/threads.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_JVM_MODE_THREADS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/protocols/jmx/custom/jolokia.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_PROTOCOLS_JMX_CUSTOM_JOLOKIA';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
