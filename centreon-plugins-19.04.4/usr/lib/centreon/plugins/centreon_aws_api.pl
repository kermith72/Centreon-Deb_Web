...
$fatpacked{"cloud/aws/billing/mode/estimatedcharges.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_BILLING_MODE_ESTIMATEDCHARGES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/billing/mode/listservices.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_BILLING_MODE_LISTSERVICES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/billing/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_BILLING_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudfront/mode/errors.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDFRONT_MODE_ERRORS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudfront/mode/requests.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDFRONT_MODE_REQUESTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudfront/mode/throughput.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDFRONT_MODE_THROUGHPUT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudfront/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDFRONT_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudwatch/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDWATCH_MODE_DISCOVERY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudwatch/mode/getalarms.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDWATCH_MODE_GETALARMS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudwatch/mode/getmetrics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDWATCH_MODE_GETMETRICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudwatch/mode/listmetrics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDWATCH_MODE_LISTMETRICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/cloudwatch/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CLOUDWATCH_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/custom/awscli.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CUSTOM_AWSCLI';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/custom/paws.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_CUSTOM_PAWS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ebs/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EBS_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  Check Amazon Elastic Block Store (Amazon EBS).
  
  =cut
CLOUD_AWS_EBS_PLUGIN

$fatpacked{"cloud/aws/ec2/mode/asgstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_ASGSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/diskio.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_DISKIO';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/instancesstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_INSTANCESSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/instancestypes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_INSTANCESTYPES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/listasg.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_LISTASG';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/listinstances.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_LISTINSTANCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/network.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_NETWORK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/mode/status.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_MODE_STATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/ec2/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_EC2_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elasticache/mode/commandsmemcached.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_COMMANDSMEMCACHED';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elasticache/mode/commandsredis.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_COMMANDSREDIS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::commandsredis;
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('GetTypeCmds', 'HashBasedCmds', 'KeyBasedCmds', 'ListBasedCmds', 'SetBasedCmds',
              'SetTypeCmds', 'SortedSetBasedCmds', 'StringBasedCmds', 'HyperLogLogBasedCmds') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' }, { name => 'timeframe' } ],
                                  closure_custom_calc => $self->can('custom_metric_calc'),
                                  closure_custom_calc_extra_options => { metric => $metric, stat => $statistic },
  ...
  Check ElastiCache cluster received commands for Redis backends
  (get and set, hash, key, list, set, sorted set, string and hyperlog log based).
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=commands-redis
  --region='eu-west-1' --name='centreon-front' --statistic='average' --critical-cmdget-average='50' --verbose --per-sec
...
$fatpacked{"cloud/aws/elasticache/mode/connections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_CONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::connections;
  ...
  sub custom_connection_perfdata {
      ...
      $self->{output}->perfdata_add(label => lc($self->{result_values}->{metric}) . "_" . lc($self->{result_values}->{stat}) . $extra_label,
  				                  unit => defined($self->{instance_mode}->{option_results}->{per_sec}) ? 'conn/s' : 'conn',
                                    value => sprintf("%.2f", defined($self->{instance_mode}->{option_results}->{per_sec}) ? $self->{result_values}->{value_per_sec} : $self->{result_values}->{value}),
                                    warning => $self->{perfdata}->get_perfdata_for_output(label => 'warning-' . lc($self->{result_values}->{metric}) . "-" . lc($self->{result_values}->{stat})),
                                    critical => $self->{perfdata}->get_perfdata_for_output(label => 'critical-' . lc($self->{result_values}->{metric}) . "-" . lc($self->{result_values}->{stat})),
                                   );
  ...
  sub custom_connection_output {
      ...
      if (defined($self->{instance_mode}->{option_results}->{per_sec})) {
          $msg = sprintf("%s: %.2f connections/s", $self->{result_values}->{metric}, $self->{result_values}->{value_per_sec});
      } else {
          $msg = sprintf("%s: %.2f connections", $self->{result_values}->{metric}, $self->{result_values}->{value});
      }
      return $msg;
  }
  ...
  sub set_counters {
      ...
      $self->{maps_counters_type} = [
          { name => 'metric', type => 1, cb_prefix_output => 'prefix_metric_output', message_multiple => "All connections metrics are ok", skipped_code => { -10 => 1 } },
      ];
  
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('CurrConnections') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' } ],
          ...
          foreach my $metric ('NewConnections') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' }, { name => 'timeframe' } ],
                                  closure_custom_calc => $self->can('custom_connection_calc'),
                                  closure_custom_calc_extra_options => { metric => $metric, stat => $statistic },
  ...
  sub check_options {
      ...
      foreach my $metric ('CurrConnections', 'NewConnections') {
          next if (defined($self->{option_results}->{filter_metric}) && $self->{option_results}->{filter_metric} ne ''
              && $metric !~ /$self->{option_results}->{filter_metric}/);
  ...
  Check ElastiCache cluster connections (current and new).
  
  Works with Memcached and Redis backends.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=connections --region='eu-west-1'
  --name='centreon-front' --statistic='average' --critical-currconnections-average='20' --verbose
...
$fatpacked{"cloud/aws/elasticache/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elasticache/mode/evictions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_EVICTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::evictions;
  ...
  sub custom_metric_perfdata {
      ...
      $self->{output}->perfdata_add(label => lc($self->{result_values}->{metric}) . "_" . lc($self->{result_values}->{stat}) . $extra_label,
  				                  unit => defined($self->{instance_mode}->{option_results}->{per_sec}) ? 'evictions/s' : 'evictions',
                                    value => sprintf("%.2f", defined($self->{instance_mode}->{option_results}->{per_sec}) ? $self->{result_values}->{value_per_sec} : $self->{result_values}->{value}),
                                    warning => $self->{perfdata}->get_perfdata_for_output(label => 'warning-' . lc($self->{result_values}->{metric}) . "-" . lc($self->{result_values}->{stat})),
                                    critical => $self->{perfdata}->get_perfdata_for_output(label => 'critical-' . lc($self->{result_values}->{metric}) . "-" . lc($self->{result_values}->{stat})),
                                   );
  ...
  sub custom_metric_output {
      ...
      if (defined($self->{instance_mode}->{option_results}->{per_sec})) {
          $msg = sprintf("%s: %.2f evictions/s", $self->{result_values}->{metric}, $self->{result_values}->{value_per_sec});
      } else {
          $msg = sprintf("%s: %.2f evictions", $self->{result_values}->{metric}, $self->{result_values}->{value});
      }
      return $msg;
  }
  ...
  sub set_counters {
      ...
      $self->{maps_counters_type} = [
          { name => 'metric', type => 1, cb_prefix_output => 'prefix_metric_output', message_multiple => "All evictions metrics are ok", skipped_code => { -10 => 1 } },
      ];
  
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('Evictions', 'Reclaimed') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' }, { name => 'timeframe' } ],
                                  closure_custom_calc => $self->can('custom_metric_calc'),
                                  closure_custom_calc_extra_options => { metric => $metric, stat => $statistic },
  ...
  Check ElastiCache cluster evictions to retreive space (evicted and reclaimed).
  
  Works with Memcached and Redis backends.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=evictions --region='eu-west-1'
  --name='centreon-front' --statistic='average' --critical-evictions-average='10' --verbose
...
$fatpacked{"cloud/aws/elasticache/mode/items.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_ITEMS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('CurrItems') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  ...
                                  perfdatas => [
                                      { label => lc($metric) . '_' . lc($statistic), value => $metric . '_' . $statistic . '_absolute', 
                                        template => '%d', unit => 'items', min => 0, label_extra_instance => 1, instance_use => 'display_absolute' },
                                  ],
                              }
                          };
              push @{$self->{maps_counters}->{metric}}, $entry;
...
$fatpacked{"cloud/aws/elasticache/mode/network.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_NETWORK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::network;
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('NetworkBytesIn', 'NetworkBytesOut') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' }, { name => 'timeframe' } ],
  ...
  Check ElastiCache cluster network usage.
  
  Works with Memcached and Redis backends.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=network --region='eu-west-1'
  --name='centreon-front' --statistic='average' --critical-networkbytesin-average='1000' --verbose
...
$fatpacked{"cloud/aws/elasticache/mode/replication.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_REPLICATION';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::replication;
  ...
  sub set_counters {
      ...
      $self->{maps_counters_type} = [
          { name => 'metric', type => 1, cb_prefix_output => 'prefix_metric_output', message_multiple => "All replication metrics are ok", skipped_code => { -10 => 1 } },
      ];
  ...
  sub check_options {
      ...
      foreach my $metric ('ReplicationBytes', 'ReplicationLag') {
          next if (defined($self->{option_results}->{filter_metric}) && $self->{option_results}->{filter_metric} ne ''
              && $metric !~ /$self->{option_results}->{filter_metric}/);
  ...
  Check ElastiCache cluster replication performances (throughput and lag).
  
  Works with Redis backends only.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=replication
  --region='eu-west-1' --name='centreon-front' --statistic='average' --critical-replicationlag-average='2' --verbose
...
$fatpacked{"cloud/aws/elasticache/mode/requestsmemcached.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_REQUESTSMEMCACHED';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::requestsmemcached;
  ...
  sub prefix_metric_output {
      ...
      return "Cluster '" . $options{instance_value}->{display} . "' " . $node_id . $options{instance_value}->{stat} . " requests ";
  }
  ...
  sub custom_metric_perfdata {
      ...
      $self->{output}->perfdata_add(label => lc($self->{result_values}->{metric}) . "_" . lc($self->{result_values}->{stat}) . $extra_label,
  				                  unit => defined($self->{instance_mode}->{option_results}->{per_sec}) ? 'req/s' : 'req',
                                    value => sprintf("%.2f", defined($self->{instance_mode}->{option_results}->{per_sec}) ? $self->{result_values}->{value_per_sec} : $self->{result_values}->{value}),
                                    warning => $self->{perfdata}->get_perfdata_for_output(label => 'warning-' . lc($self->{result_values}->{metric}) . "-" . lc($self->{result_values}->{stat})),
                                    critical => $self->{perfdata}->get_perfdata_for_output(label => 'critical-' . lc($self->{result_values}->{metric}) . "-" . lc($self->{result_values}->{stat})),
                                   );
  ...
  sub custom_metric_output {
      ...
      if (defined($self->{instance_mode}->{option_results}->{per_sec})) {
          $msg = sprintf("%s: %.2f requests/s", $self->{result_values}->{metric}, $self->{result_values}->{value_per_sec});
      } else {
          $msg = sprintf("%s: %.2f requests", $self->{result_values}->{metric}, $self->{result_values}->{value});
      }
      return $msg;
  }
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('CasHits', 'CasMisses', 'DecrHits', 'DecrMisses', 'DeleteHits', 'DeleteMisses', 'GetHits',
              'GetMisses', 'IncrHits', 'IncrMisses', 'TouchHits', 'TouchMisses') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' }, { name => 'timeframe' } ],
                                  closure_custom_calc => $self->can('custom_metric_calc'),
                                  closure_custom_calc_extra_options => { metric => $metric, stat => $statistic },
  ...
  sub check_options {
      ...
      foreach my $metric ('CasHits', 'CasMisses', 'DecrHits', 'DecrMisses', 'DeleteHits', 'DeleteMisses',
  ...
  Check ElastiCache cluster received requests for Memcached backends (found and not found keys).
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=requests-memcached
  --region='eu-west-1' --name='centreon-front' --statistic='average' --critical-getmisses-average='5' --verbose
...
$fatpacked{"cloud/aws/elasticache/mode/requestsredis.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_REQUESTSREDIS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::requestsredis;
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('CacheHits', 'CacheMisses') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' }, { name => 'timeframe' } ],
                                  closure_custom_calc => $self->can('custom_metric_calc'),
                                  closure_custom_calc_extra_options => { metric => $metric, stat => $statistic },
  ...
  Check ElastiCache cluster received requests for Redis backends (successfull and unsuccessful key lookups).
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=requests-redis
  --region='eu-west-1' --name='centreon-front' --statistic='average' --critical-cachemisses-average='5' --verbose
  ...
  Thresholds critical ($metric$ can be: 'cachehits', 'cachemisses',
  $statistic$ can be: 'minimum', 'maximum', 'average', 'sum').
...
$fatpacked{"cloud/aws/elasticache/mode/usagememcached.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_USAGEMEMCACHED';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::usagememcached;
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('BytesUsedForCacheItems') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' } ],
  ...
  Check ElastiCache cluster space usage for Memcached backends.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=usage-memcached
  --region='eu-west-1' --name='centreon-front' --statistic='average' --critical-bytesusedforcacheitems-average='1614281'
  --verbose
  ...
  Thresholds warning ($metric$ can be: 'bytesusedforcacheitems',
  $statistic$ can be: 'minimum', 'maximum', 'average', 'sum').
  
  =item B<--critical-$metric$-$statistic$>
  
  Thresholds critical ($metric$ can be: 'bytesusedforcacheitems',
  $statistic$ can be: 'minimum', 'maximum', 'average', 'sum').
...
$fatpacked{"cloud/aws/elasticache/mode/usageredis.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_MODE_USAGEREDIS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::elasticache::mode::usageredis;
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('BytesUsedForCache') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'stat' } ],
                                  output_template => $metric . ': %d %s',
                                  output_change_bytes => 1,
  ...
  Check ElastiCache cluster space usage for Redis backends.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::elasticache::plugin --custommode=paws --mode=usage-redis
  --region='eu-west-1' --name='centreon-front' --statistic='average' --critical-bytesusedforcache-average='1614281'
  --verbose
...
$fatpacked{"cloud/aws/elasticache/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELASTICACHE_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elb/mode/httpcodes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELB_MODE_HTTPCODES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elb/mode/performances.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELB_MODE_PERFORMANCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elb/mode/queues.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELB_MODE_QUEUES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elb/mode/targetshealth.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELB_MODE_TARGETSHEALTH';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/elb/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_ELB_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/lambda/mode/invocations.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_LAMBDA_MODE_INVOCATIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/lambda/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_LAMBDA_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::lambda::plugin;
...
$fatpacked{"cloud/aws/rds/mode/connections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_CONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/mode/diskio.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_DISKIO';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::rds::plugin --custommode=paws --mode=diskio --region='eu-west-1'
...
$fatpacked{"cloud/aws/rds/mode/instancestatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_INSTANCESTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/mode/listclusters.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_LISTCLUSTERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/mode/listinstances.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_LISTINSTANCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::rds::mode::listinstances;
  ...
  sub run {
      ...
      $self->manage_selection(%options);
      foreach (@{$self->{instances}}) {
          $self->{output}->output_add(long_msg => sprintf("[Name = %s][AvailabilityZone = %s][Engine = %s][StorageType = %s][DBInstanceStatus = %s]",
              $_->{Name}, $_->{AvailabilityZone}, $_->{Engine}, $_->{StorageType}, $_->{DBInstanceStatus}));
      }
  ...
  sub disco_format {
      ...
      $self->{output}->add_disco_format(elements => ['name', 'availabilityzone', 'engine', 'storagetype', 'state']);
  }
...
$fatpacked{"cloud/aws/rds/mode/network.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_NETWORK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/mode/queries.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_QUERIES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::rds::plugin --custommode=paws --mode=queries --region='eu-west-1'
...
$fatpacked{"cloud/aws/rds/mode/transactions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_TRANSACTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::aws::rds::mode::transactions;
  ...
  sub set_counters {
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('ActiveTransactions', 'BlockedTransactions', 'CommitThroughput') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'type' }, { name => 'stat' } ],
                                  output_template => $metric . ': %d ops',
                                  perfdatas => [
                                      { label => lc($metric) . '_' . lc($statistic), value => $metric . '_' . $statistic . '_absolute', 
                                        template => '%d', unit => 'ops', min => 0, label_extra_instance => 1, instance_use => 'display_absolute' },
                                  ],
                              }
                          };
              push @{$self->{maps_counters}->{metric}}, $entry;
          }
          foreach my $metric ('CommitLatency') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  key_values => [ { name => $metric . '_' . $statistic }, { name => 'display' }, { name => 'type' }, { name => 'stat' } ],
                                  output_template => $metric . ': %.2f ms',
                                  perfdatas => [
  ...
  sub check_options {
      ...
      foreach my $metric ('ActiveTransactions', 'BlockedTransactions', 'CommitThroughput', 'CommitLatency') {
          next if (defined($self->{option_results}->{filter_metric}) && $self->{option_results}->{filter_metric} ne ''
              && $metric !~ /$self->{option_results}->{filter_metric}/);
  ...
  Check RDS instances transactions per second.
  
  Example: 
  perl centreon_plugins.pl --plugin=cloud::aws::rds::plugin --custommode=paws --mode=transactions --region='eu-west-1'
  --type='instance' --name='centreon-db-ppd' --filter-metric='' --statistic='average'
  --critical-blockedtransactions-average='1' --verbose
  ...
  Filter metrics (Can be: 'ActiveTransactions', 'BlockedTransactions', 'CommitThroughput', 'CommitLatency') 
  (Can be a regexp).
...
$fatpacked{"cloud/aws/rds/mode/volume.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_MODE_VOLUME';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/rds/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_RDS_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/s3/mode/bucketsize.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_S3_MODE_BUCKETSIZE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/s3/mode/objects.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_S3_MODE_OBJECTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/aws/s3/mode/requests.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_S3_MODE_REQUESTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
      ...
      foreach my $statistic ('minimum', 'maximum', 'average', 'sum') {
          foreach my $metric ('AllRequests', 'GetRequests', 'PutRequests', 'DeleteRequests', 'HeadRequests', 'PostRequests', 'ListRequests') {
              my $entry = { label => lc($metric) . '-' . lc($statistic), set => {
                                  ...
                                  perfdatas => [
                                      { label => lc($metric) . '_' . lc($statistic), value => $metric . '_' . $statistic . '_absolute', 
                                        template => '%d', unit => 'requests', min => 0, label_extra_instance => 1, instance_use => 'display_absolute' },
                                  ],
                              }
                          };
              push @{$self->{maps_counters}->{metric}}, $entry;
...
$fatpacked{"cloud/aws/s3/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AWS_S3_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
