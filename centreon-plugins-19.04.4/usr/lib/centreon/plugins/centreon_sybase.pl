...
$fatpacked{"database/sybase/mode/blockedprocesses.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SYBASE_MODE_BLOCKEDPROCESSES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sybase/mode/connectedusers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SYBASE_MODE_CONNECTEDUSERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sybase/mode/databasessize.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SYBASE_MODE_DATABASESSIZE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sybase/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SYBASE_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
