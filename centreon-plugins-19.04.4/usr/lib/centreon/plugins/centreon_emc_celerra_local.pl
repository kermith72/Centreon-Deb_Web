...
$fatpacked{"storage/emc/celerra/local/mode/components/controlstation.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_CELERRA_LOCAL_MODE_COMPONENTS_CONTROLSTATION';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/emc/celerra/local/mode/components/datamover.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_CELERRA_LOCAL_MODE_COMPONENTS_DATAMOVER';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/emc/celerra/local/mode/getreason.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_CELERRA_LOCAL_MODE_GETREASON';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/emc/celerra/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_CELERRA_LOCAL_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package storage::emc::celerra::local::plugin;
  ...
  Check EMC Celerra NAS. Use the EMC clariion plugin for the storage.
