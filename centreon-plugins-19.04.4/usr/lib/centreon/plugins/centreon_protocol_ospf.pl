...
$fatpacked{"apps/protocols/ospf/snmp/mode/neighbor.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_OSPF_SNMP_MODE_NEIGHBOR';
  #
...
$fatpacked{"apps/protocols/ospf/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_OSPF_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
