...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/diskio.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_DISKIO';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/listresources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_LISTRESOURCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/network.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_NETWORK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      foreach my $aggregation ('minimum', 'maximum', 'average', 'total') {
          foreach my $metric ('Network In', 'Network Out') {
              my $metric_perf = lc($metric);
              my $metric_label = lc($metric);
              $metric_perf =~ s/ /_/g;
              $metric_label =~ s/ /-/g;
  ...
  Thresholds warning ($metric$ can be: 'network-in', 'network-out', 
  $aggregation$ can be: 'minimum', 'maximum', 'average', 'total').
  
  =item B<--critical-$metric$-$aggregation$>
  
  Thresholds critical ($metric$ can be: 'network-in', 'network-out', 
  $aggregation$ can be: 'minimum', 'maximum', 'average', 'total').
...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/vmsizes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_VMSIZES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/vmsstate.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_VMSSTATE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/compute/virtualmachine/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
