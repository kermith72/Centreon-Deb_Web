...
$fatpacked{"network/fortinet/fortimanager/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIMANAGER_SNMP_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub run {
      ...
      my $oid_fmSysCpuUsage = '.1.3.6.1.4.1.12356.103.2.1.1.0';
...
$fatpacked{"network/fortinet/fortimanager/snmp/mode/devicestatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIMANAGER_SNMP_MODE_DEVICESTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/fortinet/fortimanager/snmp/mode/disk.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIMANAGER_SNMP_MODE_DISK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub manage_selection {
      ...
      my $oid_fmSysDiskCapacity = '.1.3.6.1.4.1.12356.103.2.1.5.0'; # MB
      my $oid_fmSysDiskUsage = '.1.3.6.1.4.1.12356.103.2.1.4.0'; # MB
...
$fatpacked{"network/fortinet/fortimanager/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIMANAGER_SNMP_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/fortinet/fortimanager/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIMANAGER_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
