...
$fatpacked{"apps/php/apc/web/mode/filecache.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PHP_APC_WEB_MODE_FILECACHE';
  #
...
$fatpacked{"apps/php/apc/web/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PHP_APC_WEB_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/php/apc/web/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PHP_APC_WEB_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
