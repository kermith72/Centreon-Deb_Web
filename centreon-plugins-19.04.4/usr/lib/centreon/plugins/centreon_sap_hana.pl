...
$fatpacked{"database/sap/hana/mode/blockedtransactions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_MODE_BLOCKEDTRANSACTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sap/hana/mode/connectedusers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_MODE_CONNECTEDUSERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sap/hana/mode/diskusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_MODE_DISKUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package database::sap::hana::mode::diskusage;
  ...
  sub set_counters {
      ...
      $self->{maps_counters_type} = [
          { name => 'disk', type => 1, cb_prefix_output => 'prefix_volume_output', message_multiple => 'All disks are ok' },
      ];
...
$fatpacked{"database/sap/hana/mode/hostcpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_MODE_HOSTCPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sap/hana/mode/hostmemory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_MODE_HOSTMEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/sap/hana/mode/volumeusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_MODE_VOLUMEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package database::sap::hana::mode::volumeusage;
  ...
  sub set_counters {
      ...
      $self->{maps_counters_type} = [
          { name => 'volume', type => 1, cb_prefix_output => 'prefix_volume_output', message_multiple => 'All data volumes are ok' },
      ];
  ...
  sub manage_selection {
      ...
      while ((my $row = $options{sql}->fetchrow_hashref())) {
          my $volume_name = $row->{HOST} . ':' . $row->{FILE_NAME};
          
          if (defined($self->{option_results}->{filter_name}) && $self->{option_results}->{filter_name} ne '' &&
              $volume_name !~ /$self->{option_results}->{filter_name}/) {
              $self->{output}->output_add(long_msg => "skipping  '" . $volume_name . "': no matching filter.", debug => 1);
              next;
          }
...
$fatpacked{"database/sap/hana/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_SAP_HANA_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
