...
$fatpacked{"apps/cisco/ise/restapi/custom/xmlapi.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_ISE_RESTAPI_CUSTOM_XMLAPI';
  #
...
$fatpacked{"apps/cisco/ise/restapi/mode/session.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_ISE_RESTAPI_MODE_SESSION';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/cisco/ise/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_ISE_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::cisco::ise::restapi::plugin;
  ...
  Check Cisco ISE (Identity Services Engine) API.
