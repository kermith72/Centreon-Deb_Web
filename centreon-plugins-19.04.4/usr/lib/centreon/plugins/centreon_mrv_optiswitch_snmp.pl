...
$fatpacked{"network/mrv/optiswitch/snmp/mode/components/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_COMPONENTS_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/mrv/optiswitch/snmp/mode/components/fan.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_COMPONENTS_FAN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/mrv/optiswitch/snmp/mode/components/psu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_COMPONENTS_PSU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/mrv/optiswitch/snmp/mode/environment.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_ENVIRONMENT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::mrv::optiswitch::snmp::mode::environment;
  ...
  sub set_system {
      ...
      $self->{components_path} = 'network::mrv::optiswitch::snmp::mode::components';
      $self->{components_module} = ['cpu', 'psu', 'fan'];
  }
  ...
  Set to overload default threshold values (syntax: section,[instance,]status,regexp)
  It used before default thresholds (order stays).
  Example: --threshold-overload='fan,CRITICAL,^(?!(notActive)$)'
...
$fatpacked{"network/mrv/optiswitch/snmp/mode/interfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_INTERFACES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/mrv/optiswitch/snmp/mode/listinterfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_LISTINTERFACES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/mrv/optiswitch/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/mrv/optiswitch/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MRV_OPTISWITCH_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::mrv::optiswitch::snmp::plugin;
  ...
  Check MRV OptiSwitch equipments in SNMP.
