...
$fatpacked{"network/juniper/ggsn/mode/apnstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_GGSN_MODE_APNSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/ggsn/mode/globalstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_GGSN_MODE_GLOBALSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/ggsn/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_GGSN_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::juniper::ggsn::plugin;
