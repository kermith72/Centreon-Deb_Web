...
$fatpacked{"cloud/azure/network/virtualnetwork/mode/listvirtualnetworks.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_NETWORK_VIRTUALNETWORK_MODE_LISTVIRTUALNETWORKS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/network/virtualnetwork/mode/peeringsstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_NETWORK_VIRTUALNETWORK_MODE_PEERINGSSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/network/virtualnetwork/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_NETWORK_VIRTUALNETWORK_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::azure::network::virtualnetwork::plugin;
  ...
  Check Microsoft Azure Virtual Network.
