...
$fatpacked{"centreon/common/cisco/ironport/xmlapi/mode/systemusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CISCO_IRONPORT_XMLAPI_MODE_SYSTEMUSAGE';
  #
...
$fatpacked{"network/cisco/esa/xmlapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_CISCO_ESA_XMLAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::cisco::esa::xmlapi::plugin;
  ...
  sub new {
      ...
      $self->{version} = '0.1';
      %{$self->{modes}} = (
          'system-usage'  => 'centreon::common::cisco::ironport::xmlapi::mode::systemusage',
      );
  ...
  Check Cisco ESA (Email Security Appliance) through xml status page.
