...
$fatpacked{"apps/haproxy/snmp/mode/backendusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_HAPROXY_SNMP_MODE_BACKENDUSAGE';
  #
...
$fatpacked{"apps/haproxy/snmp/mode/frontendusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_HAPROXY_SNMP_MODE_FRONTENDUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/haproxy/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_HAPROXY_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
