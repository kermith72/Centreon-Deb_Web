...
$fatpacked{"apps/openldap/ldap/mode/systemusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENLDAP_LDAP_MODE_SYSTEMUSAGE';
  #
...
$fatpacked{"apps/openldap/ldap/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENLDAP_LDAP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
