...
$fatpacked{"apps/nsclient/restapi/mode/query.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NSCLIENT_RESTAPI_MODE_QUERY';
  #
...
$fatpacked{"apps/nsclient/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NSCLIENT_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
