...
$fatpacked{"storage/hp/msl/snmp/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_MSL_SNMP_MODE_HARDWARE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_system {
      ...
      $self->{regexp_threshold_overload_check_section_option} = '^(library)$';
...
$fatpacked{"storage/hp/msl/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_HP_MSL_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package storage::hp::msl::snmp::plugin;
  ...
  Check HP StoreEver MSL in SNMP.
