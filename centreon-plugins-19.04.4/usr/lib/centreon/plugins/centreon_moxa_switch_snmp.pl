...
$fatpacked{"network/moxa/switch/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MOXA_SWITCH_SNMP_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/moxa/switch/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MOXA_SWITCH_SNMP_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{memory} = [
          { label => 'usage', set => {
                  ...
                  perfdatas => [
                      { label => 'used', value => 'used_absolute', template => '%.2f',
                        threshold_total => 'total_absolute', cast_int => 1,
...
$fatpacked{"network/moxa/switch/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_MOXA_SWITCH_SNMP_PLUGIN';
  #
