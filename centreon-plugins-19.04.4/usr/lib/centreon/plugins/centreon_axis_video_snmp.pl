...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/audio.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_AUDIO';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/casing.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_CASING';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/fan.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_FAN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/psu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_PSU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package hardware::devices::video::axis::snmp::mode::components::psu;
  ...
  sub load {
      ...
      push @{$self->{request}}, { oid => $mapping->{axisPsState}->{oid} };
  }
  ...
  sub check {
      ...
      foreach my $oid ($self->{snmp}->oid_lex_sort(keys %{$self->{results}->{$mapping->{axisPsState}->{oid}}})) {
          next if ($oid !~ /^$mapping->{axisPsState}->{oid}\.(.*)$/);
          my $instance = $1;
          my $result = $self->{snmp}->map_instance(mapping => $mapping, results => $self->{results}->{$mapping->{axisPsState}->{oid}}, instance => $instance);
          
          next if ($self->check_filter(section => 'psu', instance => $instance));
          $self->{components}->{psu}->{total}++;
  
          $self->{output}->output_add(long_msg => sprintf("power supply '%s' state is %s [instance: %s].",
                                      $instance, $result->{axisPsState}, $instance
                                      ));
          my $exit = $self->get_severity(section => 'psu', value => $result->{axisPsState});
          if (!$self->{output}->is_status(value => $exit, compare => 'ok', litteral => 1)) {
              $self->{output}->output_add(severity =>  $exit,
                                          short_msg => sprintf("power supply '%s' state is %s", 
                                                               $instance, $result->{axisPsState}));
          }
      }
  }
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/storage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_STORAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/temperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_TEMPERATURE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/components/video.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_COMPONENTS_VIDEO';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/mode/environment.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_MODE_ENVIRONMENT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/video/axis/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_VIDEO_AXIS_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package hardware::devices::video::axis::snmp::plugin;
  ...
  Check Video Camera Axis in SNMP.
