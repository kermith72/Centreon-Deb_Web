...
$fatpacked{"apps/squid/snmp/mode/cacheusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SQUID_SNMP_MODE_CACHEUSAGE';
  #
...
$fatpacked{"apps/squid/snmp/mode/protocolstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SQUID_SNMP_MODE_PROTOCOLSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/squid/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SQUID_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::squid::snmp::plugin;
