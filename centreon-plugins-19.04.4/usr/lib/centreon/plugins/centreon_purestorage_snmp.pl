...
$fatpacked{"storage/purestorage/snmp/mode/stats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_PURESTORAGE_SNMP_MODE_STATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/purestorage/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_PURESTORAGE_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package storage::purestorage::snmp::plugin;
  ...
  sub new {
      ...
      $self->{version} = '0.1';
      %{$self->{modes}} = (
          'stats' => 'storage::purestorage::snmp::mode::stats',
      );
