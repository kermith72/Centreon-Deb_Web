...
$fatpacked{"apps/java/weblogic/jmx/mode/workmanager.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_WEBLOGIC_JMX_MODE_WORKMANAGER';
  #
...
$fatpacked{"apps/java/weblogic/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_WEBLOGIC_JMX_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
