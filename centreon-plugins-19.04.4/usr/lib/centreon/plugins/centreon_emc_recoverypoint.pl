...
$fatpacked{"storage/emc/recoverypoint/ssh/mode/monitoredparameters.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_RECOVERYPOINT_SSH_MODE_MONITOREDPARAMETERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/emc/recoverypoint/ssh/mode/systemstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_RECOVERYPOINT_SSH_MODE_SYSTEMSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/emc/recoverypoint/ssh/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_RECOVERYPOINT_SSH_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
