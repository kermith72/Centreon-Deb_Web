...
$fatpacked{"apps/voip/asterisk/snmp/mode/channelusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_SNMP_MODE_CHANNELUSAGE';
  #
...
$fatpacked{"apps/voip/asterisk/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
