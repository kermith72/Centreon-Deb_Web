...
$fatpacked{"apps/sendmail/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SENDMAIL_SNMP_PLUGIN';
  #
  ...
  package apps::sendmail::snmp::plugin;
  ...
  Check Sendmail MTA server in SNMP.
...
$fatpacked{"snmp_standard/mode/mtausage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'SNMP_STANDARD_MODE_MTAUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
