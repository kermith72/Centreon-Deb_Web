...
$fatpacked{"apps/nginx/serverstatus/mode/connections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NGINX_SERVERSTATUS_MODE_CONNECTIONS';
  #
...
$fatpacked{"apps/nginx/serverstatus/mode/requests.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NGINX_SERVERSTATUS_MODE_REQUESTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/nginx/serverstatus/mode/responsetime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NGINX_SERVERSTATUS_MODE_RESPONSETIME';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/nginx/serverstatus/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NGINX_SERVERSTATUS_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
