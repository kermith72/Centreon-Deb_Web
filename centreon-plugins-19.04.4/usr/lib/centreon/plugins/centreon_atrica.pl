...
$fatpacked{"network/atrica/snmp/mode/connections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ATRICA_SNMP_MODE_CONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/atrica/snmp/mode/listconnections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ATRICA_SNMP_MODE_LISTCONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/atrica/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ATRICA_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::atrica::snmp::plugin;
  ...
  Check Atrica equipments in SNMP.
