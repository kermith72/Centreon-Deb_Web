...
$fatpacked{"cloud/prometheus/restapi/mode/expression.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_PROMETHEUS_RESTAPI_MODE_EXPRESSION';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/prometheus/restapi/mode/targetstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_PROMETHEUS_RESTAPI_MODE_TARGETSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/prometheus/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_PROMETHEUS_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package cloud::prometheus::restapi::plugin;
