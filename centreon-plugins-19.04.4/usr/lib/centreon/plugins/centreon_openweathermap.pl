...
$fatpacked{"apps/openweathermap/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENWEATHERMAP_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/openweathermap/restapi/mode/cityweather.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENWEATHERMAP_RESTAPI_MODE_CITYWEATHER';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/openweathermap/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENWEATHERMAP_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
