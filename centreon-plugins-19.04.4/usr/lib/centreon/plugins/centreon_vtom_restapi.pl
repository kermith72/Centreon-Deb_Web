...
$fatpacked{"apps/vtom/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VTOM_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/vtom/restapi/mode/jobstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VTOM_RESTAPI_MODE_JOBSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vtom/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VTOM_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
