...
$fatpacked{"apps/voip/asterisk/ami/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_AMI_CUSTOM_API';
  #
...
$fatpacked{"apps/voip/asterisk/ami/mode/channelusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_AMI_MODE_CHANNELUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/voip/asterisk/ami/mode/dahdistatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_AMI_MODE_DAHDISTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/voip/asterisk/ami/mode/sippeersusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_AMI_MODE_SIPPEERSUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/voip/asterisk/ami/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_ASTERISK_AMI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
