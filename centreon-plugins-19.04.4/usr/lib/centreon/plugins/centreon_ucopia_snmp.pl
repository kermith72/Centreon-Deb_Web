...
$fatpacked{"network/ucopia/wlc/snmp/mode/temperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UCOPIA_WLC_SNMP_MODE_TEMPERATURE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ucopia/wlc/snmp/mode/users.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UCOPIA_WLC_SNMP_MODE_USERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ucopia/wlc/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UCOPIA_WLC_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
