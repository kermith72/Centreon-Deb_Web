...
$fatpacked{"apps/centreon/map/jmx/mode/brokerstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_MODE_BROKERSTATS';
...
$fatpacked{"apps/centreon/map/jmx/mode/enginestats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_MODE_ENGINESTATS';
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
...
$fatpacked{"apps/centreon/map/jmx/mode/events.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_MODE_EVENTS';
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
...
$fatpacked{"apps/centreon/map/jmx/mode/openviews.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_MODE_OPENVIEWS';
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
...
$fatpacked{"apps/centreon/map/jmx/mode/sessions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_MODE_SESSIONS';
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
...
$fatpacked{"apps/centreon/map/jmx/mode/syncstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_MODE_SYNCSTATS';
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
...
$fatpacked{"apps/centreon/map/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_MAP_JMX_PLUGIN';
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
