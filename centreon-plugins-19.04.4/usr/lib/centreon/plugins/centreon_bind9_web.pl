...
$fatpacked{"apps/bind9/web/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BIND9_WEB_CUSTOM_API';
  #
...
$fatpacked{"apps/bind9/web/mode/memoryusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BIND9_WEB_MODE_MEMORYUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/bind9/web/mode/serverusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BIND9_WEB_MODE_SERVERUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/bind9/web/mode/zoneusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BIND9_WEB_MODE_ZONEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/bind9/web/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BIND9_WEB_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
