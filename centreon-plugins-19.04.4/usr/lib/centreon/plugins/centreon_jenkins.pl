...
$fatpacked{"apps/jenkins/mode/jobstate.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JENKINS_MODE_JOBSTATE';
  #
...
$fatpacked{"apps/jenkins/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JENKINS_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  Check Jenkins through its JSON API
