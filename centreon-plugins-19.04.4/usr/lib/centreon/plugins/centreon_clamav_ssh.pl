...
$fatpacked{"apps/antivirus/clamav/local/mode/updatestatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_ANTIVIRUS_CLAMAV_LOCAL_MODE_UPDATESTATUS';
  #
...
$fatpacked{"apps/antivirus/clamav/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_ANTIVIRUS_CLAMAV_LOCAL_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
