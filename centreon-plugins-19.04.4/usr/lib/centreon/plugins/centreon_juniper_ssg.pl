...
$fatpacked{"network/juniper/common/screenos/snmp/mode/components/fan.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_COMPONENTS_FAN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/components/module.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_COMPONENTS_MODULE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/components/psu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_COMPONENTS_PSU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/components/temperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_COMPONENTS_TEMPERATURE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_HARDWARE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/listvpn.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_LISTVPN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::juniper::common::screenos::snmp::mode::listvpn;
  ...
  sub run {
      ...
      foreach my $instance (sort keys %{$self->{vpn}}) { 
          $self->{output}->output_add(long_msg => '[name = ' . $self->{vpn}->{$instance}->{name} . 
                                                  "] [p1state = " . $self->{vpn}->{$instance}->{p1state} . 
                                                  "] [p2state = " . $self->{vpn}->{$instance}->{p2state} . ']'
          );
      }
  ...
  sub disco_format {
      ...
      $self->{output}->add_disco_format(elements => ['name', 'p1state', 'p2state']);
  }
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/nsrp.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_NSRP';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/sessions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_SESSIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/vpnstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_VPNSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/common/screenos/snmp/mode/vpnusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_SCREENOS_SNMP_MODE_VPNUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/ssg/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_SSG_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
