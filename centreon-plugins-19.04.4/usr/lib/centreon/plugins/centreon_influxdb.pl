...
$fatpacked{"database/influxdb/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_CUSTOM_API';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/influxdb/mode/connectiontime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_MODE_CONNECTIONTIME';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/influxdb/mode/databasestatistics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_MODE_DATABASESTATISTICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/influxdb/mode/httpserverstatistics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_MODE_HTTPSERVERSTATISTICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/influxdb/mode/listdatabases.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_MODE_LISTDATABASES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package database::influxdb::mode::listdatabases;
...
$fatpacked{"database/influxdb/mode/query.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_MODE_QUERY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/influxdb/mode/writestatistics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_MODE_WRITESTATISTICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/influxdb/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFLUXDB_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package database::influxdb::plugin;
  ...
  sub new {
      ...
      $self->{version} = '1.0';
      %{$self->{modes}} = (
          'connection-time'           => 'database::influxdb::mode::connectiontime',
          'database-statistics'       => 'database::influxdb::mode::databasestatistics',
          'http-server-statistics'    => 'database::influxdb::mode::httpserverstatistics',
          'list-databases'            => 'database::influxdb::mode::listdatabases',
          'query'                     => 'database::influxdb::mode::query',
          'write-statistics'          => 'database::influxdb::mode::writestatistics',
      );
                          
      $self->{custom_modes}{api} = 'database::influxdb::custom::api';
      return $self;
  }
