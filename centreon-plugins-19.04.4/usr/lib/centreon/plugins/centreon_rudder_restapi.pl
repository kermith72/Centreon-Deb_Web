...
$fatpacked{"apps/rudder/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/rudder/restapi/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_DISCOVERY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/mode/globalcompliance.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_GLOBALCOMPLIANCE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/mode/listnodes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_LISTNODES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/mode/listrules.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_LISTRULES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/mode/nodecompliance.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_NODECOMPLIANCE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{global} = [
          { label => 'node-compliance', set => {
                  ...
                  perfdatas => [
                      { label => 'node_compliance', value => 'compliance_absolute', template => '%.2f',
...
$fatpacked{"apps/rudder/restapi/mode/nodesoverallcompliance.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_NODESOVERALLCOMPLIANCE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/mode/rulecompliance.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_RULECOMPLIANCE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/mode/statistics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_MODE_STATISTICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/rudder/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_RUDDER_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
