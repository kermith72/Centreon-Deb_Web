...
$fatpacked{"hardware/ats/eaton/snmp/mode/inputlines.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_ATS_EATON_SNMP_MODE_INPUTLINES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{line} = [
          { label => 'voltage', nlabel => 'line.input.voltage.volt', set => {
                  ...
                  perfdatas => [
                      { value => 'voltage_absolute', template => '%s', 
          ...
          { label => 'frequence', nlabel => 'line.input.frequence.hertz', set => {
                  ...
                  perfdatas => [
                      { value => 'frequency_absolute', template => '%.2f',
...
$fatpacked{"hardware/ats/eaton/snmp/mode/outputline.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_ATS_EATON_SNMP_MODE_OUTPUTLINE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{oline} = [
          ...
          { label => 'current', nlabel => 'line.current.ampere', set => {
                  ...
                  perfdatas => [
                      { template => '%s', value => 'current_absolute',
                        unit => 'A', min => 0 },
                  ],
              }
          },
...
$fatpacked{"hardware/ats/eaton/snmp/mode/system.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_ATS_EATON_SNMP_MODE_SYSTEM';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/ats/eaton/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_ATS_EATON_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package hardware::ats::eaton::snmp::plugin;
  ...
  sub new {
      ...
      $self->{version} = '0.1';
      %{$self->{modes}} = (
          'input-lines'   => 'hardware::ats::eaton::snmp::mode::inputlines',
          'system'        => 'hardware::ats::eaton::snmp::mode::system',
          'output-line'   => 'hardware::ats::eaton::snmp::mode::outputline',
      );
