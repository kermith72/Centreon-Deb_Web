...
$fatpacked{"storage/nimble/snmp/mode/globalstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_NIMBLE_SNMP_MODE_GLOBALSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/nimble/snmp/mode/volumeusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_NIMBLE_SNMP_MODE_VOLUMEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/nimble/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_NIMBLE_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
