...
$fatpacked{"network/cisco/meraki/cloudcontroller/snmp/mode/deviceusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_CISCO_MERAKI_CLOUDCONTROLLER_SNMP_MODE_DEVICEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/cisco/meraki/cloudcontroller/snmp/mode/listdevices.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_CISCO_MERAKI_CLOUDCONTROLLER_SNMP_MODE_LISTDEVICES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/cisco/meraki/cloudcontroller/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_CISCO_MERAKI_CLOUDCONTROLLER_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
