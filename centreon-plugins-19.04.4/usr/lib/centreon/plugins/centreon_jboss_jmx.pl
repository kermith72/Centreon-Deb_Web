...
$fatpacked{"apps/java/jboss/jmx/mode/datasourceusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_JBOSS_JMX_MODE_DATASOURCEUSAGE';
  #
...
$fatpacked{"apps/java/jboss/jmx/mode/listdatasources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_JBOSS_JMX_MODE_LISTDATASOURCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/java/jboss/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_JBOSS_JMX_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
