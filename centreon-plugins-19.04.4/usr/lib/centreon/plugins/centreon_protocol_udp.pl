...
$fatpacked{"apps/protocols/udp/mode/connection.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_UDP_MODE_CONNECTION';
  #
...
$fatpacked{"apps/protocols/udp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_UDP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::protocols::udp::plugin;
