...
$fatpacked{"cloud/azure/storage/storageaccount/mode/accountusedcapacity.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_ACCOUNTUSEDCAPACITY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/blobcapacity.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_BLOBCAPACITY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      foreach my $aggregation ('total') {
          foreach my $metric ('BlobCapacity') {
              my $metric_label = lc($metric);
              my $entry = { label => $metric_label . '-' . $aggregation, set => {
                                  key_values => [ { name => $metric_label . '_' . $aggregation }, { name => 'display' }, { name => 'stat' } ],
                                  output_template => $metric . ': %s %s',
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/blobcontainercount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_BLOBCONTAINERCOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      foreach my $aggregation ('average', 'total') {
          foreach my $metric ('ContainerCount') {
              my $metric_label = lc($metric);
              my $entry = { label => $metric_label . '-' . $aggregation, set => {
                                  key_values => [ { name => $metric_label . '_' . $aggregation }, { name => 'display' }, { name => 'stat' } ],
                                  ...
                                  perfdatas => [
                                      { label => $metric_label . '_' . $aggregation, value => $metric_label . '_' . $aggregation . '_absolute', 
                                        template => '%s', label_extra_instance => 1, instance_use => 'display_absolute',
                                        min => 0 },
                                  ],
                              }
                          };
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/blobcount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_BLOBCOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/filecapacity.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_FILECAPACITY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/filecount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_FILECOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/filesharecount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_FILESHARECOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/listresources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_LISTRESOURCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/queuecapacity.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_QUEUECAPACITY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/queuecount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_QUEUECOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/queuemessagecount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_QUEUEMESSAGECOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/tablecapacity.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TABLECAPACITY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/tablecount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TABLECOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/tableentitycount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TABLEENTITYCOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/transactionsavailability.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TRANSACTIONSAVAILABILITY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/transactionscount.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TRANSACTIONSCOUNT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/transactionslatency.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TRANSACTIONSLATENCY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/mode/transactionsthroughput.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_MODE_TRANSACTIONSTHROUGHPUT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/storage/storageaccount/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_STORAGE_STORAGEACCOUNT_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
