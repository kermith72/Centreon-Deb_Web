...
$fatpacked{"apps/slack/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SLACK_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/slack/restapi/mode/countchannels.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SLACK_RESTAPI_MODE_COUNTCHANNELS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/slack/restapi/mode/countmembers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SLACK_RESTAPI_MODE_COUNTMEMBERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/slack/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SLACK_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
