...
$fatpacked{"network/sonus/sbc/snmp/mode/callstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SONUS_SBC_SNMP_MODE_CALLSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/sonus/sbc/snmp/mode/channels.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SONUS_SBC_SNMP_MODE_CHANNELS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/sonus/sbc/snmp/mode/dspstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SONUS_SBC_SNMP_MODE_DSPSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/sonus/sbc/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SONUS_SBC_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
