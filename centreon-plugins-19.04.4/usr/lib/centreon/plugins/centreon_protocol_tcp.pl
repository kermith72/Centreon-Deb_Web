...
$fatpacked{"apps/protocols/tcp/mode/responsetime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_TCP_MODE_RESPONSETIME';
  #
...
$fatpacked{"apps/protocols/tcp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_TCP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::protocols::tcp::plugin;
