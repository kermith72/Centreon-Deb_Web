...
$fatpacked{"storage/exagrid/snmp/mode/serverusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EXAGRID_SNMP_MODE_SERVERUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/exagrid/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EXAGRID_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
