...
$fatpacked{"hardware/kvm/avocent/acs/6000/snmp/mode/components/psu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_KVM_AVOCENT_ACS_6000_SNMP_MODE_COMPONENTS_PSU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/kvm/avocent/acs/6000/snmp/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_KVM_AVOCENT_ACS_6000_SNMP_MODE_HARDWARE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package hardware::kvm::avocent::acs::6000::snmp::mode::hardware;
...
$fatpacked{"hardware/kvm/avocent/acs/6000/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_KVM_AVOCENT_ACS_6000_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
