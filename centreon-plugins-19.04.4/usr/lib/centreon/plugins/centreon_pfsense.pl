...
$fatpacked{"apps/pfsense/snmp/mode/listpfinterfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PFSENSE_SNMP_MODE_LISTPFINTERFACES';
  #
...
$fatpacked{"apps/pfsense/snmp/mode/packetstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PFSENSE_SNMP_MODE_PACKETSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/pfsense/snmp/mode/pfinterfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PFSENSE_SNMP_MODE_PFINTERFACES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/pfsense/snmp/mode/runtime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PFSENSE_SNMP_MODE_RUNTIME';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/pfsense/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PFSENSE_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
