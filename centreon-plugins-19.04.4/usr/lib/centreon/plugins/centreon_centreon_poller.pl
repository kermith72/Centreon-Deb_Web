...
$fatpacked{"apps/centreon/local/mode/bamservice.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_BAMSERVICE';
  #
...
$fatpacked{"apps/centreon/local/mode/brokerstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_BROKERSTATS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/mode/centreonpluginsversion.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_CENTREONPLUGINSVERSION';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/mode/downtimetrap.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_DOWNTIMETRAP';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/mode/dummy.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_DUMMY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/mode/metaservice.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_METASERVICE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/mode/notsodummy.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_NOTSODUMMY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/mode/retentionbroker.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_MODE_RETENTIONBROKER';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/centreon/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CENTREON_LOCAL_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
