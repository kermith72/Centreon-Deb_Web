...
$fatpacked{"network/riverbed/interceptor/snmp/mode/neighborconnections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_RIVERBED_INTERCEPTOR_SNMP_MODE_NEIGHBORCONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/riverbed/interceptor/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_RIVERBED_INTERCEPTOR_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
