...
$fatpacked{"apps/selenium/mode/scenario.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SELENIUM_MODE_SCENARIO';
  #
...
$fatpacked{"apps/selenium/mode/scenariokatalon.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SELENIUM_MODE_SCENARIOKATALON';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/selenium/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SELENIUM_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
