...
$fatpacked{"apps/openvpn/omi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENVPN_OMI_CUSTOM_API';
  #
...
$fatpacked{"apps/openvpn/omi/mode/serverusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENVPN_OMI_MODE_SERVERUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/openvpn/omi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_OPENVPN_OMI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::openvpn::omi::plugin;
  ...
  Check Openvpn through management interface.
