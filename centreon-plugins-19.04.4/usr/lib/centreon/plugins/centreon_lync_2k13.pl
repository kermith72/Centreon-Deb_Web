...
$fatpacked{"apps/lync/2013/mssql/mode/lyncusers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_LYNC_2013_MSSQL_MODE_LYNCUSERS';
  #
...
$fatpacked{"centreon/common/microsoft/skype/mssql/mode/appsharingqoe.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_MICROSOFT_SKYPE_MSSQL_MODE_APPSHARINGQOE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/microsoft/skype/mssql/mode/audioqoe.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_MICROSOFT_SKYPE_MSSQL_MODE_AUDIOQOE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/microsoft/skype/mssql/mode/poorcalls.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_MICROSOFT_SKYPE_MSSQL_MODE_POORCALLS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/microsoft/skype/mssql/mode/sessionstypes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_MICROSOFT_SKYPE_MSSQL_MODE_SESSIONSTYPES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/microsoft/skype/mssql/mode/videoqoe.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_MICROSOFT_SKYPE_MSSQL_MODE_VIDEOQOE';
...
$fatpacked{"database/mssql/dbi.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_DBI';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/backupage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_BACKUPAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/blockedprocesses.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_BLOCKEDPROCESSES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/cachehitratio.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_CACHEHITRATIO';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/connectedusers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_CONNECTEDUSERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/databasessize.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_DATABASESSIZE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/deadlocks.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_DEADLOCKS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/failedjobs.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_FAILEDJOBS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/listdatabases.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_LISTDATABASES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/lockswaits.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_LOCKSWAITS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/mode/logssize.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_LOGSSIZE';
  #
...
$fatpacked{"database/mssql/mode/transactions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_MODE_TRANSACTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mssql/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MSSQL_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
