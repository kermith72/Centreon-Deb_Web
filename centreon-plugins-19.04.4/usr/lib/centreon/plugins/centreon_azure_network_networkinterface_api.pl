...
$fatpacked{"cloud/azure/network/networkinterface/mode/listresources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_NETWORK_NETWORKINTERFACE_MODE_LISTRESOURCES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/network/networkinterface/mode/traffic.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_NETWORK_NETWORKINTERFACE_MODE_TRAFFIC';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      foreach my $aggregation ('minimum', 'maximum', 'average', 'total') {
          foreach my $metric ('BytesReceivedRate', 'BytesSentRate') {
          ...
          foreach my $metric ('PacketsSentRate', 'PacketsReceivedRate') {
              my $metric_perf = lc($metric);
              my $metric_label = lc($metric);
              $metric_perf =~ s/ /_/g;
              $metric_label =~ s/ /-/g;
  ...
  sub check_options {
      ...
      foreach my $metric ('BytesReceivedRate', 'BytesSentRate', 'PacketsSentRate', 'PacketsReceivedRate') {
...
$fatpacked{"cloud/azure/network/networkinterface/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_NETWORK_NETWORKINTERFACE_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
