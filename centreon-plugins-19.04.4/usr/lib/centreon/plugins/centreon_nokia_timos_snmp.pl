...
$fatpacked{"network/nokia/timos/snmp/mode/bgpusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_BGPUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_HARDWARE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/isisusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_ISISUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/l2tpusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_L2TPUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/ldpusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_LDPUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/listbgp.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_LISTBGP';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/listisis.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_LISTISIS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/listldp.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_LISTLDP';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/listsap.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_LISTSAP';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/listvrtr.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_LISTVRTR';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/nokia/timos/snmp/mode/sapusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_MODE_SAPUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{sap} = [
          ...
          { label => 'traffic-in-below-cir', set => {
                  key_values => [ { name => 'sapBaseStatsIngressQchipForwardedInProfOctets', diff => 1 }, { name => 'display' } ],
                  per_second => 1, output_change_bytes => 2,
                  output_template => 'Traffic In Below CIR : %s %s/s',
                  perfdatas => [
                      { label => 'traffic_in_below_cir', value => 'sapBaseStatsIngressQchipForwardedInProfOctets_per_second', template => '%.2f',
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'traffic-in-above-cir', set => {
                  key_values => [ { name => 'sapBaseStatsIngressQchipForwardedOutProfOctets', diff => 1 }, { name => 'display' } ],
                  per_second => 1, output_change_bytes => 2,
                  output_template => 'Traffic In Above CIR : %s %s/s',
                  perfdatas => [
                      { label => 'traffic_in_above_cir', value => 'sapBaseStatsIngressQchipForwardedOutProfOctets_per_second', template => '%.2f',
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'traffic-out-below-cir', set => {
                  key_values => [ { name => 'sapBaseStatsEgressQchipForwardedInProfOctets', diff => 1 }, { name => 'display' } ],
                  per_second => 1, output_change_bytes => 2,
                  output_template => 'Traffic Out Below CIR : %s %s/s',
                  perfdatas => [
                      { label => 'traffic_out_below_cir', value => 'sapBaseStatsEgressQchipForwardedInProfOctets_per_second', template => '%.2f',
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'traffic-out-above-cir', set => {
                  ...
                  perfdatas => [
                      { label => 'traffic_out_above_cir', value => 'sapBaseStatsEgressQchipForwardedOutProfOctets_per_second', template => '%.2f',
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
...
$fatpacked{"network/nokia/timos/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_NOKIA_TIMOS_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
