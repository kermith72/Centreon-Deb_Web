...
$fatpacked{"cloud/ovh/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_OVH_RESTAPI_CUSTOM_API';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/ovh/restapi/mode/quotausage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_OVH_RESTAPI_MODE_QUOTAUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/ovh/restapi/mode/sms.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_OVH_RESTAPI_MODE_SMS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{sms} = [
          { label => 'left', set => {
                  ...
                  perfdatas => [
                      { label => 'left', value => 'left_absolute', template => '%s', unit => 'sms',
...
$fatpacked{"cloud/ovh/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_OVH_RESTAPI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
