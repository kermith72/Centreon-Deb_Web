...
$fatpacked{"storage/dell/TL2000/mode/globalstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_DELL_TL2000_MODE_GLOBALSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package storage::dell::TL2000::mode::globalstatus;
...
$fatpacked{"storage/dell/TL2000/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_DELL_TL2000_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package storage::dell::TL2000::plugin;
  ...
  Check Dell TL2000 in SNMP.
  Cannot get possible values of some OIDs (even from dell support):
