...
$fatpacked{"apps/redis/cli/custom/rediscli.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_CUSTOM_REDISCLI';
  #
...
$fatpacked{"apps/redis/cli/mode/clients.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_CLIENTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/mode/commands.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_COMMANDS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/mode/connections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_CONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/mode/persistence.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_PERSISTENCE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/mode/replication.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_MODE_REPLICATION';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/redis/cli/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_REDIS_CLI_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
