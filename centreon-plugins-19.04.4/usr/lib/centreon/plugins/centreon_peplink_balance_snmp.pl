...
$fatpacked{"network/peplink/balance/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_PEPLINK_BALANCE_SNMP_MODE_CPU';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/peplink/balance/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_PEPLINK_BALANCE_SNMP_MODE_MEMORY';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/peplink/balance/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_PEPLINK_BALANCE_SNMP_PLUGIN';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
