...
$fatpacked{"database/mongodb/custom/driver.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_CUSTOM_DRIVER';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/collectionstatistics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_COLLECTIONSTATISTICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/connections.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_CONNECTIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/connectiontime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_CONNECTIONTIME';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/databasestatistics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_DATABASESTATISTICS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/listdatabases.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_LISTDATABASES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/queries.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_QUERIES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/mode/replicationstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_MODE_REPLICATIONSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/mongodb/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_MONGODB_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
