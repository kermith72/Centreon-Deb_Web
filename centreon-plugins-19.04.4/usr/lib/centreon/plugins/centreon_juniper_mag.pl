...
$fatpacked{"network/juniper/common/ive/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_IVE_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  Check CPU Utilization of the IVE system (JUNIPER-IVE-MIB).
...
$fatpacked{"network/juniper/common/ive/mode/disk.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_IVE_MODE_DISK';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub run {
      ...
      my $exit_code = $self->{perfdata}->threshold_check(value => $result->{$oid_diskFullPercent}, 
                                  threshold => [ { label => 'critical', 'exit_litteral' => 'critical' }, { label => 'warning', exit_litteral => 'warning' } ]);
      $self->{output}->output_add(severity => $exit_code,
...
$fatpacked{"network/juniper/common/ive/mode/logfile.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_IVE_MODE_LOGFILE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub run {
      ...
      my $oid_logFullPercent = '.1.3.6.1.4.1.12532.1.0';
      
      my $result = $self->{snmp}->get_leef(oids => [$oid_logFullPercent], nothing_quit => 1);
      my $exit_code = $self->{perfdata}->threshold_check(value => $result->{$oid_logFullPercent}, 
                                  threshold => [ { label => 'critical', 'exit_litteral' => 'critical' }, { label => 'warning', exit_litteral => 'warning' } ]);
      $self->{output}->output_add(severity => $exit_code,
                                  short_msg => sprintf("Log File Usage is %.2f%%", 
                                      $result->{$oid_logFullPercent}));
      $self->{output}->perfdata_add(label => 'used', unit => '%',
  ...
  Check log file usage (JUNIPER-IVE-MIB).
...
$fatpacked{"network/juniper/common/ive/mode/users.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_COMMON_IVE_MODE_USERS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/juniper/mag/mode/bladetemperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_MAG_MODE_BLADETEMPERATURE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::juniper::mag::mode::bladetemperature;
...
$fatpacked{"network/juniper/mag/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_JUNIPER_MAG_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
