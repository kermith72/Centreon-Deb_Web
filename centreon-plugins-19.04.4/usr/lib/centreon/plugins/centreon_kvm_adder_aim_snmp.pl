...
$fatpacked{"hardware/kvm/adder/aim/snmp/mode/deviceusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_KVM_ADDER_AIM_SNMP_MODE_DEVICEUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/kvm/adder/aim/snmp/mode/serverusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_KVM_ADDER_AIM_SNMP_MODE_SERVERUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/kvm/adder/aim/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_KVM_ADDER_AIM_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package hardware::kvm::adder::aim::snmp::plugin;
  ...
  sub new {
      ...
      $self->{version} = '1.0';
      %{$self->{modes}} = (
          'device-usage' => 'hardware::kvm::adder::aim::snmp::mode::deviceusage',
          'server-usage' => 'hardware::kvm::adder::aim::snmp::mode::serverusage',
      );
  ...
  Check ADDERLink Infinity Manager in SNMP.
