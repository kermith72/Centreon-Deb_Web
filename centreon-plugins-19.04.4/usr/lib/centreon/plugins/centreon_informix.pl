...
$fatpacked{"database/informix/sql/mode/archivelevel0.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_ARCHIVELEVEL0';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/checkpoints.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_CHECKPOINTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/chunkstates.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_CHUNKSTATES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/dbspacesusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_DBSPACESUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/globalcache.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_GLOBALCACHE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/listdatabases.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_LISTDATABASES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/listdbspaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_LISTDBSPACES';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/lockoverflow.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_LOCKOVERFLOW';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/logfilesusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_LOGFILESUSAGE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/longtxs.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_LONGTXS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub run {
      ...
      $self->{sql}->query(query => q{
  SELECT count(*) as num FROM syssesprof WHERE longtxs=1
  });
  
      my ($number) = $self->{sql}->fetchrow_array();
      if (!defined($number)) {
          $self->{output}->add_option_msg(short_msg => "Cannot get number of long transactions.");
          $self->{output}->option_exit();
      }
      
      my $exit_code = $self->{perfdata}->threshold_check(value => $number, threshold => [ { label => 'critical', 'exit_litteral' => 'critical' }, { label => 'warning', exit_litteral => 'warning' } ]);
      $self->{output}->output_add(severity => $exit_code,
                                  short_msg => sprintf("Current long transactions: %d", $number)
                                  );
  ...
  Check number of current long transactions.
...
$fatpacked{"database/informix/sql/mode/sessions.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_SESSIONS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/mode/tablelocks.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_MODE_TABLELOCKS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"database/informix/sql/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'DATABASE_INFORMIX_SQL_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
