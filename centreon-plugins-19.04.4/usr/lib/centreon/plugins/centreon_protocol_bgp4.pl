...
$fatpacked{"apps/protocols/bgp/4/mode/bgppeerstate.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_BGP_4_MODE_BGPPEERSTATE';
  #
...
$fatpacked{"apps/protocols/bgp/4/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_BGP_4_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
