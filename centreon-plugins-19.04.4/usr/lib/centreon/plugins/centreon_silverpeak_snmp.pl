...
$fatpacked{"network/silverpeak/snmp/mode/alarms.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SILVERPEAK_SNMP_MODE_ALARMS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/silverpeak/snmp/mode/status.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SILVERPEAK_SNMP_MODE_STATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/silverpeak/snmp/mode/uptime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SILVERPEAK_SNMP_MODE_UPTIME';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/silverpeak/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SILVERPEAK_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
