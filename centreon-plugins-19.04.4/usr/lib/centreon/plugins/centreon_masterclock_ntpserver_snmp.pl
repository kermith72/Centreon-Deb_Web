...
$fatpacked{"hardware/devices/masterclock/ntp100gps/snmp/mode/gpsstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_MASTERCLOCK_NTP100GPS_SNMP_MODE_GPSSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/masterclock/ntp100gps/snmp/mode/ntpperformance.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_MASTERCLOCK_NTP100GPS_SNMP_MODE_NTPPERFORMANCE';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/masterclock/ntp100gps/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_MASTERCLOCK_NTP100GPS_SNMP_PLUGIN';
  #
  ...
  Check Masterclock NTP100-GPS NTP servers through SNMP
