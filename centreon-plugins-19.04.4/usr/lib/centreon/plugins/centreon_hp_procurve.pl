...
$fatpacked{"network/hp/procurve/snmp/mode/components/fan.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_COMPONENTS_FAN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/mode/components/psu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_COMPONENTS_PSU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/mode/components/sensor.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_COMPONENTS_SENSOR';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_CPU';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package network::hp::procurve::snmp::mode::cpu;
  ...
  sub run {
      ...
      my $result = $self->{snmp}->get_leef(oids => [$oid_hpSwitchCpuStat], nothing_quit => 1);
      
      my $exit = $self->{perfdata}->threshold_check(value => $result->{$oid_hpSwitchCpuStat}, 
                                                    threshold => [ { label => 'critical', 'exit_litteral' => 'critical' }, { label => 'warning', exit_litteral => 'warning' } ]);
      $self->{output}->output_add(severity => $exit,
                                  short_msg => sprintf("CPU Usage: %.2f%%", $result->{$oid_hpSwitchCpuStat})
                                  );
      $self->{output}->perfdata_add(label => "cpu_usage", unit => '%',
                                    value => $result->{$oid_hpSwitchCpuStat},
...
$fatpacked{"network/hp/procurve/snmp/mode/environment.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_ENVIRONMENT';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_MEMORY';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  Check Switch HP Procurve in SNMP.
