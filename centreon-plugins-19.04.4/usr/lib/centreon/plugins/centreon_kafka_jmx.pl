...
$fatpacked{"apps/java/kafka/jmx/mode/globalstats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_KAFKA_JMX_MODE_GLOBALSTATS';
  #
...
$fatpacked{"apps/java/kafka/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_KAFKA_JMX_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  package apps::java::kafka::jmx::plugin;
  ...
  Check Kafka in JMX. Need Jolokia agent.
