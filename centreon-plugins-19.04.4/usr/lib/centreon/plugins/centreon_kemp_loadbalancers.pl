...
$fatpacked{"network/kemp/snmp/mode/hastatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_KEMP_SNMP_MODE_HASTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/kemp/snmp/mode/listvs.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_KEMP_SNMP_MODE_LISTVS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/kemp/snmp/mode/rsstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_KEMP_SNMP_MODE_RSSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{rs} = [
          ...
          { label => 'active', set => {
                  ...
                  perfdatas => [
                      { label => 'active', value => 'rSActiveConns_absolute', template => '%s', 
                        min => 0, label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'in-traffic', set => {
                  key_values => [ { name => 'rSInBytes', diff => 1 }, { name => 'display' } ],
                  output_template => 'Traffic In : %s %s/s',
                  per_second => 1, output_change_bytes => 2,
                  perfdatas => [
                      { label => 'traffic_in', value => 'rSInBytes_per_second', template => '%.2f', 
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'out-traffic', set => {
                  key_values => [ { name => 'rSOutBytes', diff => 1 }, { name => 'display' } ],
                  output_template => 'Traffic Out : %s %s/s',
                  per_second => 1, output_change_bytes => 2,
                  perfdatas => [
                      { label => 'traffic_out', value => 'rSOutBytes_per_second', template => '%.2f', 
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
...
$fatpacked{"network/kemp/snmp/mode/vsstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_KEMP_SNMP_MODE_VSSTATUS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  ...
  sub set_counters {
      ...
      $self->{maps_counters}->{vs} = [
          ...
          { label => 'active', set => {
                  ...
                  output_template => 'Active connections : %s',
                  perfdatas => [
                      { label => 'active', value => 'vSActivConns_absolute', template => '%s', 
                        min => 0, label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'in-traffic', set => {
                  key_values => [ { name => 'vSInBytes', diff => 1 }, { name => 'display' } ],
                  output_template => 'Traffic In : %s %s/s',
                  per_second => 1, output_change_bytes => 2,
                  perfdatas => [
                      { label => 'traffic_in', value => 'vSInBytes_per_second', template => '%.2f', 
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
          { label => 'out-traffic', set => {
                  key_values => [ { name => 'vSOutBytes', diff => 1 }, { name => 'display' } ],
                  output_template => 'Traffic Out : %s %s/s',
                  per_second => 1, output_change_bytes => 2,
                  perfdatas => [
                      { label => 'traffic_out', value => 'vSOutBytes_per_second', template => '%.2f', 
                        min => 0, unit => 'b/s', label_extra_instance => 1, instance_use => 'display_absolute' },
                  ],
              }
          },
...
$fatpacked{"network/kemp/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_KEMP_SNMP_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
