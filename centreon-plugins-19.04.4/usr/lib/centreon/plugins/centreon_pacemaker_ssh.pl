...
$fatpacked{"apps/pacemaker/local/mode/clustat.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PACEMAKER_LOCAL_MODE_CLUSTAT';
  #
...
$fatpacked{"apps/pacemaker/local/mode/constraints.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PACEMAKER_LOCAL_MODE_CONSTRAINTS';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/pacemaker/local/mode/crm.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PACEMAKER_LOCAL_MODE_CRM';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/pacemaker/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PACEMAKER_LOCAL_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
