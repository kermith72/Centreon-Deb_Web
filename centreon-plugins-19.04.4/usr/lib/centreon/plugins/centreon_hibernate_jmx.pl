...
$fatpacked{"apps/java/hibernate/jmx/mode/stats.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_HIBERNATE_JMX_MODE_STATS';
  #
...
$fatpacked{"apps/java/hibernate/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_JAVA_HIBERNATE_JMX_PLUGIN';
  #
  # Copyright 2019 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
