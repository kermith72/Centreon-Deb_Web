...
create_cmd_local() {
  ...
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu --warning=$_SERVICEWARNING$ --critical=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  ...
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-average;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu --warning-average=$_SERVICEWARNING$ --critical-average=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-core
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-core;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu --warning-core=$_SERVICEWARNING$ --critical-core=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  # cmd_os_linux_local_cpu-detailed
  exist_object CMD cmd_os_linux_local_cpu-det-user
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-user;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-user=$_SERVICEWARNING$ --critical-user=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-nice
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-nice;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-nice=$_SERVICEWARNING$ --critical-nice=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-system
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-system;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-system=$_SERVICEWARNING$ --critical-system=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-idle
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-idle;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-idle=$_SERVICEWARNING$ --critical-idle=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-wait
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-wait;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-wait=$_SERVICEWARNING$ --critical-wait=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-kernel
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-kernel;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-kernel=$_SERVICEWARNING$ --critical-kernel=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-interrupt
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-interrupt;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-interrupt=$_SERVICEWARNING$ --critical-interrupt=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-softirq
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-softirq;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-softirq=$_SERVICEWARNING$ --critical-softirq=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  
  exist_object CMD cmd_os_linux_local_cpu-det-steal
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_cpu-det-steal;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=cpu-detailed --warning-steal=$_SERVICEWARNING$ --critical-steal=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
  ...
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_load;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=load --warning=$_SERVICEWARNING$ --critical=$_SERVICECRITICAL$ $_SERVICEOPTION$ '

  # cmd_os_linux_local_swap
  exist_object CMD cmd_os_linux_local_swap
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_swap;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=swap --warning=$_SERVICEWARNING$ --critical=$_SERVICECRITICAL$ $_SERVICEOPTION$ '

  # cmd_os_linux_local_memory
  exist_object CMD cmd_os_linux_local_memory
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_memory;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=memory --warning=$_SERVICEWARNING$ --critical=$_SERVICECRITICAL$ $_SERVICEOPTION$ '

  # cmd_os_linux_local_disk_name
  exist_object CMD cmd_os_linux_local_disk_name
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_disk_name;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=storage --name=$_SERVICEDISKNAME$ --warning-usage=$_SERVICEWARNING$ --critical-usage=$_SERVICECRITICAL$ $_SERVICEOPTION$ '

  # cmd_os_linux_local_network_name
  exist_object CMD cmd_os_linux_local_network_name
  [ $? -ne 0 ] && $CLAPI -o CMD -a ADD -v 'cmd_os_linux_local_network_name;check;$CENTREONPLUGINS$/centreon_plugins.pl --plugin=os::linux::local::plugin --mode=traffic --speed=$_SERVICESPEED$ --name=$_SERVICEINTERFACE$ --warning-out=$_SERVICEWARNING$ --critical-out=$_SERVICECRITICAL$ --warning-in=$_SERVICEWARNING$ --critical-in=$_SERVICECRITICAL$ $_SERVICEOPTION$ '
