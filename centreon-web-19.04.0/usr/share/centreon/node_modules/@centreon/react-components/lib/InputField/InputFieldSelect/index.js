...
function (_Component) {
  ...
  function InputFieldSelect() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(InputFieldSelect)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(InputFieldSelect, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactSelect.default, {
        className: (0, _classnames.default)(_inputFieldSelect.default["select-option"], _inputFieldSelect.default[customClass ? customClass : ""]),
