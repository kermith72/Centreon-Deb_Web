...
var _searchLive = _interopRequireDefault(require("./search-live.scss"));

var _ButtonActionInput = _interopRequireDefault(require("../../Button/ButtonActionInput"));

require("../SearchWithArrow/search-with-arrow.scss");
  ...
  _createClass(SearchLive, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: (0, _classnames.default)(_searchLive.default["search-live"], _searchLive.default[icon ? "custom" : ""])
      }, label && _react.default.createElement("label", null, label), _react.default.createElement("input", {
        type: "text",
        value: value,
        onChange: this.onChange.bind(this)
      }), icon ? _react.default.createElement(_ButtonActionInput.default, {
        buttonColor: "green",
        iconColor: "white",
