...
class Configurator {
  ...
  static prepareReplaceConfig({ from, to, replaceFileOnlyIfMatchRegxpInFile = null, encoding = config.Configurator.defaultEncoding, onlyFindPathsWithoutReplace = config.Configurator.defaultOnlyFindPathsWithoutReplace, saveOldFile = config.Configurator.defaultSaveOldFile, }) {
